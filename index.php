...
<body>
        ...
        <h2 style="color: white">Movie<span style="color: #ffb320">Mania</span></h2>
			...
			<nav class="main-menu">
				<ul>
					...
					<li><a href="#" style="color: #ffb320">Home</a></li>
	...
	<div class="login">
		<form method="post" action="index.php">
			...
			<div class="container"> 	
				<center><h2><span style="color: white">Login </span><span style="color: #ffb320">Here</span></h2></center>
	...
	<section class="hero-section" >
		<div class="hero-slider owl-carousel" >
			<div class="hs-item set-bg" data-setbg="img/slider-1.jpg">
				<div class="hs-text">
					<div class="container">
						<h2 style="background:rgba(20, 25, 20, 0.5);width:750px;padding:15px">The Best <span>Movies</span> Out There</h2>
						<p style="background:rgba(20, 25, 20, 0.5);width:535px;padding:15px;"> Like Horror movies? Romance? Action or Comedy? Then you're at the right place! <br> We've picked the movies you'd like! <br> Browse, select and enjoy! </p>
						<a href="aboutUs_withoutLogin.html" class="site-btn">Read More</a>
					</div>
				</div>
			</div>
